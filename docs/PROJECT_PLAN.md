...
### 🔴 紧急（下次会话优先处理）2026.04.28

| 优先级 | 任务 | 说明 |
|--------|------|------|
| P0 | 整理 tests/ 文件夹 | 删除无用测试文件，保留有效测试 |
| P0 | 整理其他文件夹 | 检查 logs/、backups/、根目录下的杂项文件 |
| P0 | 同步开发文档 | 更新 SKILL.md、code-map.md 反映最新文件结构 |
| P1 | 继续翻译功能开发 | 完成翻译模块的完整工作流（断点续传、SRT生成） |
